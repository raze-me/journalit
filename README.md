...
<h1 align="center">Journal iT</h1>
 ...
 a smart journalling web app where users can journal without the need of a physical secret journaling diary. It keeps your secrets safe and private, also you can track your mood and analyse yor journaling weekly.
...
```bash
git clone https://github.com/raze-me/journalit.git
cd jackpot
```
